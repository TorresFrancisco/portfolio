    ...
    <section id="skills" class="skills section-bg">
        <div class="container">
            ...
            <div class="section-title">
                <h2>Skills</h2>
                <p>
                    During my apprenticeship at Coding Dojo and at the Blue Latam Company I have acquired knowledge as much as
                    Front end and Back end. These are some skills that I have handled so far.
                </p>
            </div>
